...
export default function FAQ() {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: "主にAPAC地域（シンガポール、香港、タイ、マレーシア、インドネシアなど）で学ぶ日本人学生が参加しています。海外で学ぶ日本人学生のためのコミュニティです。",
    },
    {
      question: "オンライン・オフライン両方ありますか？",
      answer: "はい、両方の形式でイベントを開催しています。オンラインイベントは世界中から参加可能で、オフラインイベントは主にAPAC地域で開催しています。",
    },
    {
